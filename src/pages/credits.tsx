...
import { tailwindCSSLicense } from '../data/tailwindcss-license';
...
export default function CreditsPage({ ossLibraries }: CreditsPageProps) {
    const pageTitle = 'Credits - VideoSpeedup.com';
    const pageDescription = 'Credits for VideoSpeedup.com';
    ...
    return (
        <>
            <NextHead>
                ...
                <meta
                    property="og:url"
                    content="https://www.videospeedup.com/credits"
                />
    ...
    return (
        <section>
            ...
            <details className="mt-1">
                ...
                <CodeBlock code={tailwindCSSLicense} />
            </details>
            ...
            <details className="mt-1">
                ...
                <CodeBlock code={modernNormalizeLicense} />
            </details>
        </section>
    );
}
